...
#define COMMS_PERIOD 1000 // ms for one communication cycle
#define COMMS_PERIOD_US COMMS_PERIOD * 1000 // us for one communication cycle
#define MIN_SILENT_TIME 500 // minimal time to be silent for each cycle, in ms (not starting sending new messages)
